...
function getCategoriesBooks() {
    ...
    return fetch(`${API_URL}/books/categories`, requestOptions).then(handleResponseCategories)
}
...
function patchCategory(category) {
    ...
    return axios.patch(`${API_URL}/books/category`, category, config).then((res) => {
...
function addCategoryBooks(formData) {
    ...
    return axios.post(`${API_URL}/books/addCategory`, formData, config).then((res) => {
...
function deleteCategoryBooks(id) {
    ...
    return axios.post(`${API_URL}/books/delete-category`, data, config).then((res) => {
