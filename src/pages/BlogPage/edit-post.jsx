...
const EditPost = ({ patchPost, deletePost, posts, match, getAllPosts }) => {
        ...
        <M className="paper">
            <Column>
                ...
                <div>
                    ...
                    <button className="button-gray2" onClick={handlePatchPost}>
                        Изменить пост
                    </button>
                </div>
            </Column>
...
const mapDispatchToProps = (dispatch) => {
    return {
        patchPost: (post) => dispatch(postsActions.patchPost(post)),
